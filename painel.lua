...
-- CRIAR ÍCONE MINIMALISTA MÓVEL 🥰 (bordas arredondadas e neon)
...
buttonContainer.Size = UDim2.new(0.94, 0, 0, 420)
...
-- ABA ESP (🎯)
local espY = 5
espY = createButton("COMPUTADORES", "computerESP", espY, "💻", buttonContainer)
